...
IF( EXISTS ( SELECT 1 FROM sys.sysdatabases WHERE name='REPARACIONES_UNI1_8' ) )
BEGIN
...
DROP TABLE IF EXISTS dbo.INGRESODEUDA;
DROP TABLE IF EXISTS dbo.DEUDA;
DROP TABLE IF EXISTS dbo.USOITEMS;
...
DROP TABLE IF EXISTS dbo.TIPOITEM;
DROP TABLE IF EXISTS dbo.ESTADO;
DROP TABLE IF EXISTS dbo.SESION;
DROP TABLE IF EXISTS dbo.TECNICO;
DROP TABLE IF EXISTS dbo.COMPUTADORA;
DROP TABLE IF EXISTS dbo.MODELO;
...
IF( EXISTS ( SELECT 1 FROM sys.sysobjects 
	WHERE name='DETALLE' and xtype = 'u') )
BEGIN
...
IF( EXISTS ( SELECT 1 FROM sys.sysobjects 
	WHERE name='REPARACION' and xtype = 'u') )
BEGIN
...
IF( EXISTS ( SELECT 1 FROM sys.sysobjects 
	WHERE name='TECNICO' and xtype = 'u') )
BEGIN
...
IF( EXISTS ( SELECT 1 FROM sys.sysobjects 
	WHERE name='COMPUTADORA' and xtype = 'u') )
BEGIN
